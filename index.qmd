...
+ Patel, Vrajkumar
+ Sawyer, Riley
    - Learn how to process and interpret real world questions and data.
    - Work in a collaborative setting using GitHub.
    - Gain experience using Quarto and Markdown.
+ Sudarsanam, Shreya
...
Please use the following table to sign up.
  ...
  ----- | ------------- | ------------------------- 
   ...
   02/23 | Sawyer, Riley | Decision tree/tree-based methods   
